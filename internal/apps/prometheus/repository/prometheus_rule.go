...
type RuleRepository interface {
	...
	GetByGroupAndName(ctx context.Context, groupID int, name string) (model.Rule, error)
...
// GetByGroupAndName 按组与规则名查询
func (r *ruleRepository) GetByGroupAndName(ctx context.Context, groupID int, name string) (data model.Rule, err error) {
