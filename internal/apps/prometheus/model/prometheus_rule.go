...
type Rule struct {
	...
	Name        string         `gorm:"type:varchar(64);not null;unique;comment:'告警名称'" json:"name,omitempty"`
	GroupID     int            `gorm:"gorm:foreignKey:GroupID;comment:'规则组'"            json:"groupID,omitempty"`
...
func (Rule) TableName() string {
	return "valyria_prometheus_rule"
}
