...
type Record struct {
	...
	Name      string     `gorm:"type:varchar(64);not null;uniqueIndex:uniq_prom_record_group_name;comment:'记录名称'" json:"name"`
	GroupID   int        `gorm:"not null;uniqueIndex:uniq_prom_record_group_name" json:"groupID,omitempty"`
...
func (Record) TableName() string {
	return "prom_lens_prometheus_record"
}
