...
// CredGitlabController 定义控制器结构体
type CredGitlabController struct {
	cred service.CredGitlabManager // 使用服务接口
}

func NewCredGitlabController(cred service.CredGitlabManager) *CredGitlabController {
	return &CredGitlabController{cred: cred}
}

func (c *CredGitlabController) List(ctx *gin.Context) {
...
func (c *CredGitlabController) Get(ctx *gin.Context) {
...
func (c *CredGitlabController) Create(ctx *gin.Context) {
...
func (c *CredGitlabController) Update(ctx *gin.Context) {
	var data model.CredGitlab
...
func (c *CredGitlabController) Delete(ctx *gin.Context) {
	var id, _ = strconv.Atoi(ctx.Param("id"))
