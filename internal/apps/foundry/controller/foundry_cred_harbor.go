...
// CredHarborController 定义控制器结构体
type CredHarborController struct {
	cred service.CredHarborManager // 使用服务接口
}

func NewCredHarborController(cred service.CredHarborManager) *CredHarborController {
	return &CredHarborController{cred: cred}
}

func (c *CredHarborController) List(ctx *gin.Context) {
...
func (c *CredHarborController) Get(ctx *gin.Context) {
...
func (c *CredHarborController) Create(ctx *gin.Context) {
...
func (c *CredHarborController) Update(ctx *gin.Context) {
	var data model.CredHarbor
...
func (c *CredHarborController) Delete(ctx *gin.Context) {
	var id, _ = strconv.Atoi(ctx.Param("id"))
