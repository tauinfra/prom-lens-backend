...
type PipelineManager interface {
	List(ctx context.Context, id int, ns string) ([]repository.Pipeline, error)
...
// List 列表
func (s *pipelineManager) List(ctx context.Context, id int, ns string) ([]repository.Pipeline, error) {
	return s.pipeline.List(ctx, id, ns)
}

// Get 查询
func (s *pipelineManager) Get(ctx context.Context, id int, ns, name string) (*v1.Pipeline, error) {
	return s.pipeline.Get(ctx, id, ns, name)
}

// Create 创建
func (s *pipelineManager) Create(ctx context.Context, id int, ns string, body *v1.Pipeline) (*v1.Pipeline, error) {
	return s.pipeline.Create(ctx, id, ns, body)
}

// Update 更新
func (s *pipelineManager) Update(ctx context.Context, id int, ns string, body *v1.Pipeline) (*v1.Pipeline, error) {
	return s.pipeline.Update(ctx, id, ns, body)
}

// Delete 删除
func (s *pipelineManager) Delete(ctx context.Context, id int, ns, name string) (err error) {
