...
type PipelineRunManager interface {
	List(ctx context.Context, id int, ns string) ([]repository.PipelineRun, error)
...
// List 列表
func (s *pipelineRunManager) List(ctx context.Context, id int, ns string) ([]repository.PipelineRun, error) {
	return s.pipelineRun.List(ctx, id, ns)
}

// Get 查询
func (s *pipelineRunManager) Get(ctx context.Context, id int, ns, name string) (*v1.PipelineRun, error) {
	return s.pipelineRun.Get(ctx, id, ns, name)
}

// Create 创建
func (s *pipelineRunManager) Create(ctx context.Context, id int, ns string, body *v1.PipelineRun) (*v1.PipelineRun, error) {
	return s.pipelineRun.Create(ctx, id, ns, body)
}

// Update 更新
func (s *pipelineRunManager) Update(ctx context.Context, id int, ns string, body *v1.PipelineRun) (*v1.PipelineRun, error) {
	return s.pipelineRun.Update(ctx, id, ns, body)
}

// Delete 删除
func (s *pipelineRunManager) Delete(ctx context.Context, id int, ns, name string) (err error) {
